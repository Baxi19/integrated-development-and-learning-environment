...
import com.application.views.newproject.NewProjectView;
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Integrated Development and Learning Environment logo"));
        logoLayout.add(new H1("Integrated Development and Learning Environment"));
